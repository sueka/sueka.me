...
のやうな訓点を振っておくと^[総ルビで、ルビの無い単語はいはゆる置き字。]、訓点に従って書き下し文にして、適当に句読点を補ふだけで、
...
[^8]: この記事では、原文はすでに著作権が消滅してゐるものに限った。

---

ところで、右縦書きと左横書きには、*書字方向を時計回りに直角に回した方向が行送り方向となる*といふ共通点がある。和文の縦組みで欧文や数式、プログラムなどの左横書きされるべきものを時計回りに直角に回して組むことができるのはこれのおかげだ[^1]。
