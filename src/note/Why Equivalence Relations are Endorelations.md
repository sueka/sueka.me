...
計算機プログラムでは、[2]{.upright}つの項が<b>同じ</b>であることを表現する手段が[2]{.upright}つある。等価性[^1]と同値関係である。[2]{.upright}つの値が同じ解釈、つまり、値に対応する抽象実体[^2]を持つ<ruby>とき<rt lang="en">iff</ruby>、<i>それらの値は等価である</i>。
