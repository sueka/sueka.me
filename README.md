...
To deploy manually, upload `_site` directory to your server, by executing a command such as `scp _sites/ http@203.0.113.89:/srv/http/www/html` or taking other ways.
