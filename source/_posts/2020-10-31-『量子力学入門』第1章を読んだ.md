...
[『量子力学入門』](https://www.maruzen-publishing.co.jp/item/?book_no=294393) 第1章（量子力学の「あらすじ」）を読みました。読み返すときのために迷ったところを補足しておきます。練習問題を解いてみたので、その答案も公開します。
...
光速度は、真空中かどうかには関心が無いので、 {% katex %} c = 3.0 \times 10^8 m/s {% endkatex %} とします。
